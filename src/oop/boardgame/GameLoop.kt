package oop.boardgame

import oop.boardgame.gameobjects.*
...
fun main(args: Array<String>) {
    ...
    do {
        println("Level:$level:")
        val powerLevel = (level until mainPlayer.powerLevel).shuffled().last() * level
        ...
        println("Players health decreased to: ${mainPlayer.health}")
